...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://www.wizeinsights.com/app/";
    public static String WEBAPP_HOST = "wizeinsights.com"; // used for checking Intent-URLs
    ...
    public static int PROGRESS_THRESHOLD = 75;
